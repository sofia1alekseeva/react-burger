...
import * as orderDetailsSelector from '../../services/reducers/orderDetails/selectors';
...
export const OrderDetails = () => {
    ...
    return (
        <section className={styles.mainBlock}>
            <h1 className={`${styles.orderId} text text_type_digits-large`}>{orderDetails.order.number}</h1>
